...
class _OppointmentState extends State<Oppointment> {
  var images = [
    const AssetImage('assets/images/plombier1.jpg'),
    const AssetImage('assets/images/plombier2.jpg'),
    const AssetImage('assets/images/plombier3.jpg'),
    const AssetImage('assets/images/plombier4.jpg'),
    const AssetImage('assets/images/plombier5.jpg'),
    const AssetImage('assets/images/plombier6.jpg'),
    const AssetImage('assets/images/plombier7.png'),
  ];
  late Size size;
  var animate = false;
  var opacity = 0.0;
